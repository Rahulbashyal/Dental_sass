    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        @if($role === 'receptionist')
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <a href="{{ route('clinic.patients.create', ['iframe' => 1]) }}" data-modal-url="{{ route('clinic.patients.create', ['iframe' => 1]) }}" data-modal-title="Add" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-500 rounded-lg border border-gray-200 hover:border-green-300 transition-colors">
                    <div>
        ...
        @elseif($role === 'accountant')
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <a href="{{ route('clinic.invoices.create', ['iframe' => 1]) }}" data-modal-url="{{ route('clinic.invoices.create', ['iframe' => 1]) }}" data-modal-title="Create" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                    <div>
        ...
        @else
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('clinic.patients.create', ['iframe' => 1]) }}" data-modal-url="{{ route('clinic.appointments.create') }}" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 rounded-lg border border-gray-200 hover:border-indigo-300 transition-colors">
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-indigo-50 text-indigo-600 ring-4 ring-white">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
        ...
        @else
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('clinic.patients.create', ['iframe' => 1], 'iframe' => 1) }}" data-modal-url="{{ route('clinic.waitlist.index') }}" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-yellow-500 rounded-lg border border-gray-200 hover:border-yellow-300 transition-colors">
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-yellow-50 text-yellow-600 ring-4 ring-white">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        @else
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('clinic.patients.create', ['iframe' => 1], 'iframe' => 1, 'iframe' => 1) }}" data-modal-url="{{ route('clinic.invoices.index') }}?status=pending" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-orange-500 rounded-lg border border-gray-200 hover:border-orange-300 transition-colors">
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-orange-50 text-orange-600 ring-4 ring-white">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
        ...
        @else
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('clinic.patients.create', ['iframe' => 1], 'iframe' => 1, 'iframe' => 1) }}" data-modal-title="Add Patient
                        Register new patients" data-modal-title="Add Patient
                        ...
                        Create Invoice
                        Generate invoices" data-modal-title="Add Patient
                        Register new patients" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-500 rounded-lg border border-gray-200 hover:border-green-300 transition-colors">
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-green-50 text-green-600 ring-4 ring-white">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.764z" />
