            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-red-700">
                        <p>Your current role: <strong>{{ ucfirst($role) }}</strong></p>
                        <p>Required role: <strong>{{ ucfirst($requiredRole) }}</strong></p>
                        <p class="mt-2">Please contact your administrator if you believe this is an error.</p>
                    </div>
                </div>
            </div>
        </div>
