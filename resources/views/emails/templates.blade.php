    ...
    <div class="max-w-6xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('emails.create', ['iframe' => 1]) }}" data-modal-url="{{ route('emails.create', ['iframe' => 1]) }}" data-modal-title="Form" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                    Compose Email
                </a>
            </div>
