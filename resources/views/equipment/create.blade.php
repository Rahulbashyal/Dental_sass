...
@section('page-title', 'Clinical: Asset Initialization')
...
<div class="page-fade-in max-w-4xl mx-auto pb-12">
    ...
    <div class="stagger-in mb-8">
        <div class="flex items-center space-x-3 text-slate-500 text-sm mb-2">
            ...
            <span class="text-slate-900 font-medium tracking-tight">New Asset Node Initialization</span>
        </div>
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Initialize Asset</h1>
                <p class="text-slate-500 font-medium italic">Establishing a new Clinical Technology record</p>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('clinic.equipment.store') }}" class="space-y-6">
        @csrf
        ...
        <div class="stagger-in bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm" style="--delay: 1">
            <div class="flex items-center space-x-3 mb-8">
                ...
                <h2 class="text-xl font-bold text-slate-900 tracking-tight">Node Identity</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
                <div class="space-y-2 md:col-span-2">
                    ...
                    <input type="text" name="name" id="name" 
                        ...
                        placeholder="e.g. Ultrasonic Scaler 3000" value="{{ old('name') }}" required>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="model" id="model" 
                        ...
                        placeholder="Model Revision" value="{{ old('model') }}">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="serial_number" id="serial_number" 
                        class="w-full px-5 py-3.5 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 transition-all font-medium text-slate-700 placeholder-slate-400" 
                        placeholder="SN-000-000" value="{{ old('serial_number') }}">
                </div>
            </div>
        </div>
        ...
        <div class="stagger-in bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm" style="--delay: 2">
            <div class="flex items-center space-x-3 mb-8">
                ...
                <h2 class="text-xl font-bold text-slate-900 tracking-tight">Lifecycle Intel</h2>
            </div>
        ...
        <div class="stagger-in flex flex-col md:flex-row md:items-center justify-end gap-3 pt-4" style="--delay: 3">
            ...
            <button type="submit" class="px-10 py-4 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 active:scale-95 flex items-center justify-center space-x-2">
                ...
                <span>Validate & Register Asset</span>
            </button>
        </div>
    </form>
</div>
