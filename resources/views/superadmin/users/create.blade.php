...
<div class="space-y-8 page-fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
        <div>
            ...
            <p class="text-slate-500 font-medium mt-2">Create global administrative nodes or clinic-specific staff accounts.</p>
        </div>
        <div>
    ...
    <div class="relative bg-white rounded-[3rem] border border-slate-100 p-12 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('superadmin.users.store') }}" method="POST" class="relative z-10">
    ...
    @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="col-span-1 md:col-span-2 flex items-center gap-3 mb-2">
                    ...
                    <h2 class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Primary Credentials</h2>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="name" required 
                               ...
                               placeholder="e.g., Dr. Roshan Sharma"
                               value="{{ old('name') }}">
                    </div>
                    @error('name')
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" required 
                               class="w-full pl-11 pr-4 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/30 focus:bg-white transition-all text-sm font-bold placeholder-slate-400" 
                               placeholder="roshan.sharma@example.com"
                               value="{{ old('email') }}">
                    </div>
                    @error('email')
                        <p class="text-[10px] font-bold text-rose-500 mt-1.5 ml-1 italic">{{ $message }}</p>
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Access Passkey *</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Assigned Clinic Node (Optional)</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <select name="clinic_id" 
                            ...
                            @foreach($clinics as $clinic)
                                <option value="{{ $clinic->id }}" {{ ($selectedClinic == $clinic->id || old('clinic_id') == $clinic->id) ? 'selected' : '' }}>
                                    {{ $clinic->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="mt-12 flex items-center justify-end gap-6 pt-10 border-t border-slate-50">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-fingerprint text-blue-400 group-hover:text-blue-100 transition-colors"></i>
                    Initialize Identity
                </button>
            </div>
        </form>
