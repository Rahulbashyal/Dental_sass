...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-4">
            <a href="{{ route('clinic.treatment-plans.edit', $treatmentPlan, 'iframe' => 1) }}" data-modal-url="{{ route('clinic.treatment-plans.edit', $treatmentPlan, 'iframe' => 1) }}" data-modal-title="Edit Plan" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                Edit Plan
            </a>
